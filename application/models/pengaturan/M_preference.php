...
class M_preference extends CI_Model
{
    ...
    {
        $sql = "INSERT INTO com_preferences (pref_group, pref_nm, pref_value, mdb, created_at)
        VALUES (?,?,?,?,NOW())";
    ...
    {
        $sql = "UPDATE com_preferences SET pref_group=?, pref_nm = ?, pref_value = ?, mdb = ?, updated_at = NOW() WHERE pref_id = ?";
        return $this->db->query($sql, $params);
    }
