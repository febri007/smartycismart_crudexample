...
class Adminrole extends ApplicationBase
{
    ...
    public function process_add()
    {
        ...
        if ($this->tnotification->run() !== false) {
            $params = [$this->input->post('portal_id'), $this->input->post('role_nm'), $this->input->post('role_desc'), $this->input->post('default_page')];
            // insert
    ...
    public function process_update()
    {
        ...
        // process
        if ($this->tnotification->run() !== false) {
            $params = [$this->input->post('portal_id'), $this->input->post('role_nm'), $this->input->post('role_desc'), $this->input->post('default_page'), $this->input->post('role_id')];
            // insert
    ...
    public function process_delete()
    {
        ...
        // process
        if ($this->tnotification->run() !== false) {
            $params = [$this->input->post('role_id')];
            // insert
