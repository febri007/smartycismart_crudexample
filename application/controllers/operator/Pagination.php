...
class Pagination extends ApplicationBase
{
    protected $template = 'operator/pagination/';
    // constructor
    ...
    public function index(){
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", $this->template."/index.html");
        ...
        $config['base_url'] = site_url($this->template."index/");
        ...
        // print_r($this->uri->segment(4, 0));die();
